# Accessibility statement for Manage People on Probation

Last reviewed: 2 April 2026

This accessibility statement applies to the [Manage people on probation (MPOP) service](https://manage-people-on-probation.hmpps.service.justice.gov.uk/).
...
- some elements are not read correctly by screen readers, including buttons, links, headings, form fields and table controls 

- some information is not presented in the correct order or structure for assistive technology 

- some text and icons do not have sufficient contrast or clear meaning 

- some actions cause unexpected page changes or clear entered information 

- some labels, instructions, and naming are unclear or inconsistent across pages 

- some documents accessed through the service are in PDF format and are not accessible 

## Feedback and contact information 
If you find any problems not listed on this page or think we’re not meeting accessibility requirements, contact mpop-digital-team@justice.gov.uk. 

If you need information on this website in a different format like accessible PDF, large print, easy read, audio recording or braille, email mpop-digital-team@justice.gov.uk. 
...
The homepage person search component, and the filter components on the Documents and Contacts pages, are not placed in the correct part of the page structure, making it harder for screen reader users to find them. This fails WCAG 2.2 success criterion 1.3.1 (info and relationships
...
Documents cannot be published or edited in Manage people on probation. All documents accessed through the website are created and maintained on NDelius. 
...
This accessibility statement will be updated based on any issues we identify, or changes we make to address any issues raised. 

## Preparation of this accessibility statement 
This statement was prepared on 2 April 2026. 

This website was last tested on 3 March 2026 against the WCAG 2.2 AA standard. The test was carried out by UserVision.  

You can [read the full accessibility test report](https://uv3337-moj-mpop-plus.uservisionaccessibility.co.uk/index.html). 