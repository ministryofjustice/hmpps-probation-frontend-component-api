# Accessibility statement for Accredited Programmes
...
If you find any problems not listed on this page or think we're not meeting accessibility requirements, email [acpcommunity.digitalsupport@justice.gov.uk](mailto:acpcommunity.digitalsupport@justice.gov.uk).

If you need information on this website in a different format like accessible PDF, large print, easy read, audio recording or braille, email [acpcommunity.digitalsupport@justice.gov.uk](mailto:acpcommunity.digitalsupport@justice.gov.uk). We'll consider your request and get back to you in 7 working days.
...
While creating this service, we tested with a broad range of users, including users with declared accessibility needs. This included neurodivergent users, such as people with dyslexia or ADHD, for example so that we could check that information is presented in a way that is clear and not overwhelming.
...
We're continuing to test the service with users to check how well it is working for them, including how accessible it is. As we add or update features, we will make sure these are tested.
